...
local ConfigurationExtension = ".pearl"
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.Discord then
		...
		Settings.Discord.Invite = "EwFuXZTBCP"
	...
	if Settings.KeySystem then
		...
		if isfile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			if readfile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) == string.gsub(game:HttpGet('https://raw.githubusercontent.com/Faacts/UILibraries/main/key'), "%s", "") then
				Passthrough = true
			end
		end
		...
		if not Passthrough then
			...
			KeyMain.Title.Text = "Pearl" or Settings.Name
			KeyMain.Subtitle.Text = "Authentication" or "Key System"
			KeyMain.NoteMessage.Text = "Key Link copied! discord.gg/EwFuXZTBCP"
			Settings.KeySettings.SaveKey = true
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				pcall(function()
					if KeyMain.Input.InputBox.Text == string.gsub(game:HttpGet('https://raw.githubusercontent.com/Faacts/UILibraries/main/key'), "%s", "") then
						...
						if Settings.KeySettings.SaveKey then
							if writefile then
								writefile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, string.gsub(game:HttpGet('https://raw.githubusercontent.com/Faacts/UILibraries/main/key'), "%s", ""))
							end
